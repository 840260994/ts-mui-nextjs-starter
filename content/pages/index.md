...
sections:
  ...
  - type: CardsSection
    ...
    subtitle: >-
      ...
      dados. Estamos sempre atualizados com as últimas tendências e tecnologias
      emergentes, garantindo que nossos clientes tenham acesso às soluções mais
      avançadas do mercado. Além disso, nossa organização valoriza a parceria de
      longo prazo com nossos clientes. Estamos comprometidos em fornecer suporte
      contínuo e manutenção para garantir o funcionamento ininterrupto dos
      sistemas implantados. Nossa equipe de suporte técnico está pronta para
      ajudar e resolver quaisquer problemas que possam surgir, garantindo a
      satisfação total dos nossos clientes. Ao escolher a nossa organização como
      sua solução de TI, você terá acesso a uma equipe experiente, soluções
